...
const createClash = async (req: Request, res: Response): Promise<void> => {
  try {
    const body = req.body;
...
const getClashes = async (req: Request, res: Response): Promise<void> => {
  try {
...
const getClashById = async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
...
const updateClash = async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
    const body = req.body;
    const payload = clashSchema.parse(body);
...
const deleteClash = async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
    const clash = await prisma.clash.findUnique({
...
const createClashItems = async (req: Request, res: Response): Promise<void> => {
  try {
    const { id } = req.body;
